...
export default function SeoulFullWidthDashboard() {
    ...
    const renderContent = () => {
        switch (activeTab) {
            case "홈": return <HomeSection setActiveTab={setActiveTab} accessToken={accessToken} />;
            case "신고하기": return <ReportQRCodeSection />;
            case "신고확인": return <ReportListSection />;
            case "공지사항": return <div className="p-10 text-center font-bold">공지사항 리스트 영역</div>;
            default: return <HomeSection setActiveTab={setActiveTab} accessToken={accessToken} />;
        }
    };
